...
uint8 mpu6050_init (void)
{
    ...
    do
    {
        ...
        mpu6050_write_register(MPU6050_PWR_MGMT_1, 0x01);                       // 选择X轴陀螺仪作为时钟源
        mpu6050_write_register(MPU6050_SMPLRT_DIV, 0x0A);                       // 100Hz采样率
        mpu6050_write_register(MPU6050_CONFIG, 0x01);
        mpu6050_write_register(MPU6050_GYRO_CONFIG, MPU6050_GYR_SAMPLE);       // 2000°/s
        mpu6050_write_register(MPU6050_ACCEL_CONFIG, MPU6050_ACC_SAMPLE);       // 2g(m/s^2)
