...
#define DOT_MATRIX_SCREEN_SR0_PIN       (P00_9)
#define DOT_MATRIX_SCREEN_SR1_PIN       (P00_8)
#define DOT_MATRIX_SCREEN_SR2_PIN       (P02_8)
#define DOT_MATRIX_SCREEN_SR3_PIN       (P02_7)                 // 摩托组可以将引脚定义修改为P33_8
#define DOT_MATRIX_SCREEN_SR4_PIN       (P02_6)
#define DOT_MATRIX_SCREEN_SR5_PIN       (P02_5)
#define DOT_MATRIX_SCREEN_SR6_PIN       (P10_2)

#define DOT_MATRIX_SCREEN_ROW_NUM       (7)

void dot_matrix_screen_scan             (void);
void dot_matrix_screen_show_string      (const char *str);
void dot_matrix_screen_show_string_single(int pose,const char *str);
