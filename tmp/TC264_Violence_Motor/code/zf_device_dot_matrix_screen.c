...
const uint8 tld7002_ascii_font_5x7[][7] =
{
    ...
    { 0x08, 0x1C, 0x2A, 0x08, 0x08, 0x08, 0x08},  // !前进  1
    { 0x08, 0x08, 0x08, 0x08, 0x2A, 0x1C, 0x08},  // "  2
    { 0x08, 0x08, 0x08, 0x08, 0x2A, 0x1C, 0x08},  // # 后退 3
    ...
    { 0x1E, 0x06, 0x0A, 0x12, 0x20, 0x00, 0x00},  // < 左28
    { 0x00, 0x00, 0x3E, 0x00, 0x3E, 0x00, 0x00},  // = 29
    { 0x3C, 0x30, 0x28, 0x24, 0x02, 0x00, 0x00},  // > 右30
...
void dot_matrix_screen_show_string_single(int pose,const char *str)
{
        ...
        dot_matrix_screen_data[pose] = str[0];
