 ...
 *如果存放边界的数组用uint6定义 size_lon填2(pico_uint16 占2字节)
 * 如果存放边界的数组用uint8定义 size_lon填1(pico_uint8 占1字节) 等同于sendimgAndLine( pico_uint8 color,pico_uint8 *buff, pico_uint32 len)
 */
