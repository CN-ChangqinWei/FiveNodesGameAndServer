...
#define TLD7002_UART_INDEX      (UART_0)            // 串口号
#define TLD7002_UART_BAUD       (2000000)           // 波特率
#define TLD7002_UART_RX         (UART0_TX_P14_0)   // TLD7002驱动模块的RX与单片机的TX连接
#define TLD7002_UART_HLSIL      (UART0_RX_P14_1)   // TLD7002驱动模块的HSLI_L与单片机的RX引脚连接

#define TLD7002_GPIN0_PIN       (P00_12)             // GPIN0引脚定义
